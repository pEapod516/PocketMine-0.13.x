...
class Human extends Creature implements ProjectileSource, InventoryHolder{
	 ...
	 * @param bool   $isSlim
	 */
	public function setSkin($str, $isSlim = false, $isTransparent = null){
		$this->skin = $str;
	...
	public function spawnTo(Player $player){
		if($player !== $this and !isset($this->hasSpawned[$player->getLoaderId()])){
			...
			if($this instanceof Player){
				$this->server->updatePlayerListData($this->getUniqueId(), $this->getId(), $this->getName(), $this->isSlim, $this->skin, [$player], $this->isTransparent);
			}
